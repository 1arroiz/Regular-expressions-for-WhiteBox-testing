...
```regex
^(?![ \t]*//).*?(?:\b(?:std::process::Command(?:::new)?\s*\(|Command::new\(|spawn\(|status\(|output\(|libloading::Library::new|dlopen::sym|(?:wasmtime|wasmer)::.*(?:instantiate|execute|call))\b|\b(?:actix_multipart|actix_web::web::Payload|multipart::server|multer|rocket::fs::TempFile|axum::extract::Multipart)\b|\b(?:rusqlite::Connection::execute|rusqlite::Connection::prepare|postgres|tokio_postgres::Client::(?:query|prepare|execute)|mysql(?:::|::prelude::).*query|sqlx::query|diesel::sql_query|diesel::dsl::sql)\b.*(?:\+|format!\(|write!\(|push_str\(|to_string\(|\{.*\})|\b(?:mongodb::Collection::<[^>]+>::(?:find|find_one|update_one|update_many|aggregate|delete_one|delete_many)|mongodb::bson::doc!)\b.*(?:\$where|\$\w+)|\b(?:ldap3::LdapConn|ldap3::LdapConnAsync|ldap3::LdapHandle)\b.*(?:search|with_controls|simple_bind|sasl_bind)|\b(?:sxd_xpath::Factory|sxd_xpath::XPath|sxd_xpath::Context|select::document|roxmltree::Document)\b.*(?:evaluate|value|select|xpath)|\b(?:serde_json::from_(?:str|slice|reader)|ron::from_str|serde_yaml::from_str|toml::from_str|bincode::deserialize|postcard::from_bytes|rmp_serde::from_(?:read|slice)|ciborium::from_reader)\b|\b(?:tera::Tera::render|handlebars::Handlebars::render|askama::Template::render|maud::PreEscaped)\b|\b(?:quick_xml::Reader::from_(?:reader|file|str)|xml_rs::EventReader::new|xmltree::Element::parse|sxd_document::parser::parse)\b|\b(?:reqwest::(?:blocking::)?Client::(?:get|post|put|delete|request)|ureq::(?:get|post|request)|hyper::Client::request|isahc::prelude::RequestExt|surf::(?:get|post)|std::net::TcpStream::connect)\b|\b(?:std::fs::(?:read|read_to_string|write|remove_file|rename|copy|create_dir(?:_all)?|remove_dir(?:_all)?|read_dir|metadata|OpenOptions::new)|std::fs::File::(?:open|create)|std::io::(?:Read|Write)|std::path::Path(?:::new)?|std::os::unix::fs::PermissionsExt::set_mode)\b|\b(?:zip::read::ZipArchive::<.*>::new|zip::ZipArchive::<.*>::new|ZipArchive::by_index|ZipArchive::extract|tar::Archive::new|tar::Archive::unpack)\b|\b(?:jsonwebtoken::(?:encode|decode)|jsonwebtoken::TokenData|frank_jwt|jwt_simple::prelude)\b|\b(?:actix_web::HttpResponse::Found\(\)\.append_header\(\(.*LOCATION.*\)|rocket::response::Redirect::to|warp::redirect|axum::response::Redirect::to)\b|\b(?:actix_cors::Cors|tower_http::cors::CorsLayer|rocket_cors::Cors|warp::cors)\b|\b(?:std::thread::sleep|tokio::time::sleep|loop\s*\{|while\s+true|rayon::join|tokio::spawn|futures::stream::FuturesUnordered)\b|\b(?:fancy_regex::Regex::(?:new|is_match|captures)|onig::Regex(?:::new)?|onig::Regex::(?:search|find)|onig_sys)\b)
```
